...
/** Письмо в дизайне FitPro: зелёный акцент (как primary в Tailwind-теме), карточка, крупный код. */
...
<tr><td style="background:#16a34a;padding:20px 32px;"><span style="color:#ffffff;font-size:20px;font-weight:700;">FitPro</span></td></tr>
...
${ctaUrl ? `<a href="${ctaUrl}" style="display:inline-block;padding:12px 24px;background:#16a34a;color:#ffffff;border-radius:10px;text-decoration:none;font-weight:600;font-size:15px;">${ctaText || "Открыть FitPro"}</a>` : ""}
</td></tr>
<tr><td style="padding:20px 32px;border-top:1px solid #eef2f0;"><p style="margin:0;font-size:12px;color:#9ca3af;">Письмо отправлено автоматически — отвечать на него не нужно.<br>© FitPro</p></td></tr>
